...
typedef NS_ENUM(NSInteger, CNTOUCHBACK) {
    CNPPopupTouchEnable,
    CNPPopupTouchDisable
};
...
@property (nonatomic, assign) CNTOUCHBACK backViewTouch; // Backgound mask of the popup (Default dimmed)
