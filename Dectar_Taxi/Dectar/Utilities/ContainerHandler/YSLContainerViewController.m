...
@interface YSLContainerViewController () <UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    _contentScrollView.frame = CGRectMake(0,0 , self.view.frame.size.width, self.view.frame.size.height-140);
