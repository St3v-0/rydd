...
- (void)show
{
    ...
    self.titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(55.0 + (self.contentInset.left), titleYOrigin + (self.contentInset.top)+5, viewWidth - 70.0 - (self.contentInset.right+self.contentInset.left) , 16.0)];
...
//    self.titleLabel.layer.borderColor = [UIColor greenColor].CGColor;
    ...
    self.titleLabel.font = [UIFont fontWithName: @"Avenir-Medium" size: 18.0 ];
    self.titleLabel.backgroundColor = [UIColor clearColor];
    self.titleLabel.text = self.title;
    
    // Make the message label
    self.messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(55.0 + (self.contentInset.left), 20.0 + 10.0 +5+ (self.contentInset.top), viewWidth - 70.0 - (self.contentInset.right+self.contentInset.left), 12.0)];
    self.messageLabel.font = [UIFont fontWithName: @"Avenir-Medium" size: 14.0 ];
    ...
    UIImageView *iconView = [[UIImageView alloc]initWithFrame:CGRectMake(10.0, 15.0+5, 20.0, 30.0)];
